...
- **Inputs:** Use the Surface background, a 1px Secondary border, and Text-Primary text. The focus state uses Primary with a visible outline.
- **Loading States:** Show the new-search spinner below the search control. Show the **MORE!** spinner inside its control.
